...
@Table(name = "tb_risk_cliente_externo", schema = "risk", uniqueConstraints = @UniqueConstraint(name = "tb_risk_cliente_externo_unique", columnNames = {"empresa_id", "codigo"}))
public class ClienteExterno extends BaseEntity {
