...
@Table(name = "tb_risk_macro_processo", schema = "risk", uniqueConstraints = @UniqueConstraint(name = "tb_risk_macro_processo_unique", columnNames = {"empresa_id", "codigo"}))
public class MacroProcesso extends BaseEntity {
