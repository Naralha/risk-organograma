...
@Table(name = "tb_risk_compliance_interno", schema = "risk", uniqueConstraints = @UniqueConstraint(name = "tb_risk_compliance_interno_unique", columnNames = {"empresa_id", "codigo"}))
public class ComplianceInterno extends BaseEntity {
