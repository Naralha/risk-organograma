...
@Table(name = "tb_risk_compliance_externo", schema = "risk", uniqueConstraints = @UniqueConstraint(name = "tb_risk_compliance_externo_unique", columnNames = {"empresa_id", "codigo"}))
public class ComplianceExterno extends BaseEntity {
