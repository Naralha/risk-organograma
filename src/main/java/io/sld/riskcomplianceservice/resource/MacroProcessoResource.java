...
import io.sld.riskcomplianceservice.domain.service.MacroProcessoQueryService;
import io.sld.riskcomplianceservice.domain.service.MacroProcessoService;
import io.sld.riskcomplianceservice.domain.service.criteria.MacroProcessoCriteria;
...
/**
 * REST controller for managing {@link MacroProcesso}.
 */
@RestController
@RequestMapping("/api")
