...
import io.sld.riskcomplianceservice.domain.service.ClienteInternoProcessoQueryService;
import io.sld.riskcomplianceservice.domain.service.ClienteInternoProcessoService;
import io.sld.riskcomplianceservice.domain.service.criteria.ClienteInternoProcessoCriteria;
...
/**
 * REST controller for managing {@link ClienteInternoProcesso}.
 */
@RestController
@RequestMapping("/api")
