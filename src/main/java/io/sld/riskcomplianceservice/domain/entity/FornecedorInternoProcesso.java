...
@NoArgsConstructor
@Entity
@Table(name = "fornecedor_interno_processo")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class FornecedorInternoProcesso implements Serializable {
    ...
    public FornecedorInternoProcesso id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public FornecedorInternoProcesso idnVarOrganograma(String idnVarOrganograma) {
    ...
    public FornecedorInternoProcesso idnVarProcesso(String idnVarProcesso) {
    ...
    public FornecedorInternoProcesso idnvarUsuario(String idnvarUsuario) {
    ...
    public FornecedorInternoProcesso organograma(Organograma organograma) {
    ...
    public FornecedorInternoProcesso processo(Processo processo) {
    ...
    public FornecedorInternoProcesso usuario(Usuario usuario) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FornecedorInternoProcesso)) {
            return false;
        }
        return id != null && id.equals(((FornecedorInternoProcesso) o).id);
    }
