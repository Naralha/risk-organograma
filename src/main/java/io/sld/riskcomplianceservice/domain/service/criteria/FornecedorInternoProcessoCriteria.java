...
import io.sld.riskcomplianceservice.resource.FornecedorInternoProcessoResource;
...
/**
 * Criteria class for the {@link FornecedorInternoProcesso} entity. This class is used
 * in {@link FornecedorInternoProcessoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /fornecedor-interno-processos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class FornecedorInternoProcessoCriteria implements Serializable, Criteria {
    ...
    public FornecedorInternoProcessoCriteria() {}

    public FornecedorInternoProcessoCriteria(FornecedorInternoProcessoCriteria other) {
    ...
    @Override
    public FornecedorInternoProcessoCriteria copy() {
        return new FornecedorInternoProcessoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final FornecedorInternoProcessoCriteria that = (FornecedorInternoProcessoCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, idnVarOrganograma, idnVarProcesso, idnvarUsuario, organogramaId, processoId, usuarioId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "FornecedorInternoProcessoCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
